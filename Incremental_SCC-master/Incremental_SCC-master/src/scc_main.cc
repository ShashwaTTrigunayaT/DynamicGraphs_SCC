...
int32_t G_num_nodes;
vector<int> scc_list;
vector<int> vec_scc_count;
vector<int> level_ver;
vector<int> affect_level;
int met_algo;
int unaffect_sccs=0;
float extra_time_taken_9=0;
float extra_time_taken_6_7=0;
int trim_9=0;
int trim_7=0;
vector<int> new_edge_nodes;
int pivot_fix=0;
int good_init_pivot=0;
int yes_yes=0;
int flag11=0;
int count_trim_spec=0;
int maxi_neigh_del=0;
vector<pair<int,int> > scc_num_nodes;
int max_affec_scc=0;
int flag10=0;
int affect_sccs;
int flag33=1;
...
class my_main : public main_t
{
    ...
    public:
        virtual bool check_args(int argc, char** argv)
        {
            ...
            method = atoi(argv[0]);
            if ((method < 0) || (method > 11)) return false;
...
{
    /*G-B*/
    /*Remove the extra edges and find the SCCs*/
